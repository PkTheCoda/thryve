        ...
        <div className="max-w-[90rem] mx-auto py-20 flex flex-col items-center gap-20">
          <div className="space-y-4 text-center">
            <div className="space-y-2">
              <h3 className="tracking-widest uppercase two-title">Showcase</h3>
            ...
            <p className="one-title max-w-xl">
              Take a look at some of our client's websites ranging from large
              nonprofits to local lawn-mowing businesses to tutoring websites.
            </p>
          </div>
                ...
                <div className="w-full p-4 flex flex-col gap-y-2">
                  <div className="flex justify-between items-start">
                    <div className="text-main">
                      ...
                      <h5>{website.subtitle}</h5>
                    </div>
                    <a
                      href={website.link}
                      target="_blank"
                      className="p-4 bg-secondary rounded-full shadow-md transition300scale"
                    >
          ...
          <div className="w-full text-center two-title max-w-4xl leading-10 px-4">
            <p>
              Due to confidentiality agreements with our clients, many of our
              projects are not publicly listed. If you would like to explore
              additional examples of our work, please feel free to{" "}
              <a
